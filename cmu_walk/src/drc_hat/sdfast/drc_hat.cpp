...
drc_hat::drc_hat(){    
    int dof_num=0;
sdgtopo_drc_hat_t sdgtopo_temp = {
...
sdginput_drc_hat_t sdginput_temp = {
...
sdgerror_drc_hat_t sdgerror_temp = {
/* Error parameters
*/
    /* lasterr */ 0,
    /* lastrou */ 0,
...
void drc_hat::sdst2ang(double st[22],
    double stang[21])
{
    int i;
    double dc[3][3];
...
void drc_hat::sdang2st(double stang[21],
    double st[22])
{
    int i;
    double dc[3][3];
...
void drc_hat::sdnrmsterr(double st[22],
    double normst[22],
    int routine)
{
    int i;
...
void drc_hat::sdnormst(double st[22],
    double normst[22])
{
...
void drc_hat::sdstate(double timein,
    double qin[22],
    double uin[21])
{
/*
...
void drc_hat::sdqdot(double oqdot[22])
{
/*
...
void drc_hat::sdu2qdot(double uin[21],
    double oqdot[22])
{
/*
...
void drc_hat::sdpsstate(double lqin[1])
{
...
void drc_hat::sddomm(int routine)
{
...
void drc_hat::sddommldu(int routine)
{
    int i;
    int dumroutine,errnum;
...
void drc_hat::sdlhs(int routine)
{
...
void drc_hat::sdmfrc(double imult[21])
{
/*
...
void drc_hat::sdequivht(double tau[21])
{
...
void drc_hat::sdfulltrq(double udotin[21],
    double multin[21],
    double trqout[21])
{
...
void drc_hat::sdcomptrq(double udotin[21],
    double trqout[21])
{
...
void drc_hat::sdmulttrq(double multin[21],
    double trqout[21])
{
...
void drc_hat::sdmassmat(double *mmat)
{
...
void drc_hat::sdfrcmat(double fmat[21])
{
...
void drc_hat::sdpseudo(double lqout[1],
    double luout[1])
{
/*
...
void drc_hat::sdpsqdot(double lqdout[1])
{
/*
...
void drc_hat::sdpsudot(double ludout[1])
{
/*
...
void drc_hat::sdperr(double errs[21])
{
/*
...
void drc_hat::sdverr(double errs[21])
{
/*
...
void drc_hat::sdaerr(double errs[21])
{
/*
...
int drc_hat::sdchkbnum(int routine,
...
int drc_hat::sdchkjnum(int routine,
...
int drc_hat::sdchkucnum(int routine,
...
int drc_hat::sdchkjaxis(int routine,
...
int drc_hat::sdchkjpin(int routine,
...
void drc_hat::sdpresacc(int joint,
    int axis,
    double prval)
{
...
void drc_hat::sdpresvel(int joint,
    int axis,
    double prval)
{
...
void drc_hat::sdprespos(int joint,
    int axis,
    double prval)
{
...
void drc_hat::sdgetht(int joint,
    int axis,
    double *torque)
{
...
void drc_hat::sdhinget(int joint,
    int axis,
    double torque)
{
...
void drc_hat::sdpointf(int body,
    double point[3],
    double force[3])
{
    double torque[3];
...
void drc_hat::sddoww(int routine)
{
...
*/
        ...
        dfs[19] = 0.;
        dfs[20] = 0.;
        sdldubsl(21,21,mmap,(double*)mlo,dfs,row);
...
*/
        sdqrdcomp(21,21,21,21,wmap,wmap,(double*)ww,qraux,jpvt);
        wwflg = 1;
    }
/*
 Used 0.00 seconds CPU time,
...
void drc_hat::sdxudot0(int routine,
    double oudot0[21])
{
/*
...
*/
    sdfs0();
    sdldubslv(21,21,mmap,works,(double*)(double*)mlo,mdi,fs,udot);
    for (i = 0; i <= 20; i++) {
        oudot0[i] = udot[i];
    }
/*
...
void drc_hat::sdudot0(double oudot0[21])
{
...
void drc_hat::sdsetudot(double iudot[21])
{
/*
...
void drc_hat::sdxudotm(int routine,
    double imult[21],
    double oudotm[21])
{
/*
...
void drc_hat::sdudotm(double imult[21],
    double oudotm[21])
{
...
void drc_hat::sdderiv(double oqdot[22],
    double oudot[21])
{
/*
...
*/
    sdqrbslv(21,21,21,21,wmap,wmap,1e-13,workr,iwork,(double*)ww,qraux,jpvt,bb,mult,&
      wrank);
    for (i = 0; i <= 20; i++) {
        multmap[i] = 0;
    }
...
void drc_hat::sdresid(double eqdot[22],
    double eudot[21],
    double emults[21],
    double resid[64])
{
...
void drc_hat::sdmult(double omults[21],
    int *owrank,
    int omultmap[21])
{
    int i;
...
void drc_hat::sdreac(double force[16][3],
    double torque[16][3])
{
/*
Generated 01-Apr-2003 04:20:00 by SD/FAST, Kane's formulation
...
void drc_hat::sdmom(double lm[3],
    double am[3],
    double *ke)
{
/*
...
void drc_hat::sdsys(double *mtoto,
    double cm[3],
    double icm[3][3])
{
/*
...
void drc_hat::sdorient(int body,
    double dircos[3][3])
{
/*
...
void drc_hat::sdangvel(int body,
    double avel[3])
{
/*
...
void drc_hat::sdtrans(int frbod,
    double ivec[3],
    int tobod,
    double ovec[3])
{
...
void drc_hat::sdrel2cart(int coord,
    int body,
    double point[3],
    double linchg[3],
    double rotchg[3])
...
void drc_hat::sdangacc(int body,
    double aacc[3])
{
/*
...
void drc_hat::sdgrav(double gravin[3])
{
...
void drc_hat::sdconschg(void)
{

    wwflg = 0;
}

void drc_hat::sdstab(double velin,
    double posin)
{
...
void drc_hat::sdgetgrav(double gravout[3])
{
...
void drc_hat::sdgetmass(int body,
    double *massout)
{
...
void drc_hat::sdgetiner(int body,
    double inerout[3][3])
{
...
void drc_hat::sdgetbtj(int joint,
    double btjout[3])
{
...
void drc_hat::sdgetitj(int joint,
    double itjout[3])
{
...
void drc_hat::sdgetpin(int joint,
    int pinno,
    double pinout[3])
{
    int offs;
...
void drc_hat::sdgetpres(int joint,
    int axis,
    int *presout)
{
...
void drc_hat::sdgetstab(double *velout,
    double *posout)
{
...
void drc_hat::sdinfo(int info[50])
{
...
void drc_hat::sdcons(int consno,
    int info[50])
{
...
void drc_hat::sdgentime(int *gentm)
{

    *gentm = 42000;
}
// start of analysis routines
void drc_hat::sdposfunc(double vars[21],
    double param[1],
    double resid[21])
{
    int i;
...
void drc_hat::sdvelfunc(double vars[21],
    double param[23],
    double resid[21])
{
...
void drc_hat::sdstatfunc(double vars[21],
    double param[22],
    double resid[42])
{
...
void drc_hat::sdstdyfunc(double vars[42],
    double param[1],
    double resid[63])
{
    double pos[22],qdotdum[22];
...
void drc_hat::sdmotfunc(double time,
    double state[43],
    double dstate[43],
    double param[1],
    int *status)
...
void drc_hat::sdassemble(double time,
    double state[43],
    int lock[21],
    double tol,
    int maxevals,
    ...
    int *err)
{
    ...
    sdroot(&drc_hat::sdposfunc,state,param,21,21,0,lock,tol,tol,maxevals,
...
void drc_hat::sdinitvel(double time,
    double state[43],
    int lock[21],
    double tol,
    int maxevals,
    ...
    int *err)
{
    ...
    param[22] = time;
    sdroot(&drc_hat::sdvelfunc,&state[22],param,21,21,0,lock,tol,tol,maxevals,
...
void drc_hat::sdstatic(double time,
    double state[43],
    int lock[21],
    double ctol,
    double tol,
    ...
    int *err)
{
    ...
    param[21] = time;
    sdst2ang(state,state);
    sdroot(&drc_hat::sdstatfunc,state,param,42,21,21,lock,
...
void drc_hat::sdsteady(double time,
    double state[43],
    int lock[42],
    double ctol,
    double tol,
    ...
    int *err)
{
    ...
    sdroot(&drc_hat::sdstdyfunc,vars,param,63,42,21,lock,
      ctol,tol,maxevals,jw,dw,rw,iw,resid,fcnt,&rooterr);
...
void drc_hat::sdmotion(double *time,
    double state[43],
    double dstate[43],
    double dt,
    double ctol,
    ...
    int *err)
{
    ...
    sdvinteg(&drc_hat::sdmotfunc,&ttime,state,dstate,param,dt,&step,43,tol,work,&vintgerr,
      &which);
    *time = ttime;
    *err = vintgerr;
}
...
void drc_hat::sdfmotion(double *time,
    double state[43],
    double dstate[43],
    double dt,
    double ctol,
    ...
    int *err)
{
    ...
    *err = 0;
    ...
    sdfinteg(&drc_hat::sdmotfunc,&ttime,state,dstate,param,dt,43,work,errest,&ferr);
    if (ferr != 0) {
        *err = 1;
    }
    *time = ttime;
...
void drc_hat::sdprerrmsg(FILE *fnum,
    int routine,
    int errnum)
{
...
void drc_hat::sderror(int *routine,
    int *errnum)
{
...
void drc_hat::sdprinterr(FILE *fnum)
{

    sdprerrmsg(fnum,lastrou,lasterr);
}

void drc_hat::sdclearerr(void)
{
...
void drc_hat::sdseterr(int routine,
    int errnum)
{
...
void drc_hat::sdcalcerrs(double fval[],
    int nfunc,
    int ndes,
    int dnorm,
    double *maxderr,
...
void drc_hat::sdadjvars(void (drc_hat::*func)(double *, double *, double * ),
    double vars[],
    double param[],
    int nfunc,
    int ndes,
...
void drc_hat::sdcalcjac(void (drc_hat::*func)(double *, double *, double * ),
    double vars[],
    double param[],
    int nfunc,
    int nvar,
...
void drc_hat::sdroot(void (drc_hat::*func)(double *, double *, double *),
    double vars[],
    double param[],
    int nfunc,
    int nvar,
...
void drc_hat::sdrk4m(void (drc_hat::*func)(double, double *, double *, double *, int* ),
    double time,
    double st[],
    double dst0[],
    double param[],
...
void drc_hat::sdfinteg(void (drc_hat::*func)(double, double *, double *, double *, int *),
    double *time,
    double st[],
    double dst[],
    double param[],
...
void drc_hat::sdvinteg(void (drc_hat::*func)(double, double *, double *, double *, int *),
    double *time,
    double st[],
    double dst[],
    double param[],
...
void drc_hat::sddc2ang(double dircos[3][3],
    double *a1,
    double *a2,
    double *a3)
{
...
void drc_hat::sddc2quat(double dircos[3][3],
    double *e1,
    double *e2,
    double *e3,
    double *e4)
...
void drc_hat::sdang2dc(double a1,
    double a2,
    double a3,
    double dircos[3][3])
{
...
void drc_hat::sdquat2dc(double ie1,
    double ie2,
    double ie3,
    double ie4,
    double dircos[3][3])
...
double drc_hat::sdvdot(double ivec1[3],
...
double drc_hat::sdvnorm(double ivec[3])
...
void drc_hat::sdvcopy(double ivec[3],
    double ovec[3])
{
...
void drc_hat::sdvset(double sclr1,
    double sclr2,
    double sclr3,
    double ovec[3])
{
...
void drc_hat::sdvadd(double ivec1[3],
    double ivec2[3],
    double ovec[3])
{
...
void drc_hat::sdvsub(double ivec1[3],
    double ivec2[3],
    double ovec[3])
{
...
void drc_hat::sdvmul(double sclr,
    double ivec[3],
    double ovec[3])
{
...
void drc_hat::sdvaxpy(double sclr,
    double ivec1[3],
    double ivec2[3],
    double ovec[3])
{
...
void drc_hat::sdvcross(double ivec1[3],
    double ivec2[3],
    double ovec[3])
{
...
void drc_hat::sdvrot(double ivec[3],
    double rvec[3],
    double theta,
    double ovec[3])
{
...
void drc_hat::sdserialno(int *serno)
{
...
int drc_hat::NJNT(void){
    return nbod+nloop;
}

int drc_hat::joint(int idx){
    return idx_2_joint[idx];
}

int drc_hat::axis(int idx){
    return idx_2_axis[idx];
}

int drc_hat::aux(int idx){
    return idx_2_aux[idx];
}

int drc_hat::motor(int idx){
    return idx_2_motor[idx];
}

void drc_hat::set_aux(int *map){
    for(int i=0;i<num_controls;i++){
        idx_2_aux[i] = map[i];
    }
}

// double * drc_hat::get_q(int i){
//     return &q_local[i];
// }
// double * drc_hat::get_u(int i){
//     return &u_local[i];
// }
// double * drc_hat::get_qdot(int i){
//     return &qdot_local[i];
// }
// double * drc_hat::get_udot(int i){
//     return &udot_local[i];
// }

//drc_hat drc_hat::operator= (drc_hat x){
//    drc_hat y;
//    y.sdgtopo=x.sdgtopo;
