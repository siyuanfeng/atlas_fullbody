...
// Static member
Eigen::Matrix<double,3,1> KinematicFilter3::_gravity(0,0,-GRAVITY);
#ifdef ATLAS_ONLINE
Eigen::Matrix<double,3,1> KinematicFilter3::_imu_lin_offset(-0.0905, -0.000004, -0.012);
Eigen::Quaterniond KinematicFilter3::_imu_quat_offset(0.923879532511287, 0, 0, 0.382683432365090);   // IMU quaternion
#else
Eigen::Matrix<double,3,1> KinematicFilter3::_imu_lin_offset(0.0484, 0, -0.04087);
Eigen::Quaterniond KinematicFilter3::_imu_quat_offset(1, 0, 0, 0);   // IMU quaternion
#endif

KinematicFilter3::KinematicFilter3 (const KinematicFilter3 & other)
{
  copy(other);
}
                                                    
KinematicFilter3& KinematicFilter3::operator=(const KinematicFilter3 & other)
{
  copy(other);
  return *this; 
}

KinematicFilter3::KinematicFilter3()
{
  _P.setIdentity();
  _Q.setIdentity();
  _R.setIdentity();
...
void KinematicFilter3::updateZ(int zDim = 6)
{
  _z.setZero();  
...
void KinematicFilter3::updateX(int zDim = 6)
{
  /*if (zDim == 6){*/
  _dx= _K* _innov;
  /*}*/
...
void KinematicFilter3::computeInnovation(const Eigen::Matrix<double, 6, 1> & z)
{
  _innov = z - _z; 
}

void KinematicFilter3::makeProcessJacobian ()
{
  _A.setIdentity();
...
void KinematicFilter3::makeObservationJacobian ()
{
  _C.setIdentity();
}

// Ankle Related Stuff                        
void KinematicFilter3::computeAnkleRelated()
{
...
void KinematicFilter3::filterOneTimeStep_ss()
{ 
  predictX();
...
void KinematicFilter3::getLinearV(double *v)
{
  memcpy(v, _x.block(V0,0,3,1).data(), sizeof(double)*3); 
} 

void KinematicFilter3::getPosition(double *x)
{
  memcpy(x, _x.block(X0,0,3,1).data(), sizeof(double)*3); 
}  

void KinematicFilter3::getFootPose(int side, double *x)
{
  if (side == LEFT)
...
void KinematicFilter3::makeInputs(double *q, double *w, double *a, double *joints, double *jointsd)
{
  // dvec_cooy(_q, q, 4);
...
void KinematicFilter3::getContactState (int cs)
{
...
void KinematicFilter3::readParams(std::string &nameQ, std::string &nameR)
{
  std::ifstream in;
  in.open(nameQ.c_str());
...
// ROS
void KinematicFilter3::initKF(int type, double dt, const double root_pos[3], const double root_vel[3])
{
  modelType = type;
...
void KinematicFilter3::fill_measurement_buffer()
{
...
void KinematicFilter3::computeFootPV()
{
  computeAnkleRelated();
...
void KinematicFilter3::set_hack_footpos()
{
  if (buffer_first_time)
  {
    buffer_first_time = false;
...
void KinematicFilter3::makeMeasurement(double left_fz, double right_fz)
{
  /*
     double tmp = 0.0;
...
void KinematicFilter3::setX (const double * x, int len)
{
  assert(len == 6); 
...
// ============================================================================
void KinematicFilter3::setX (const Eigen::Matrix<double, 6, 1> & x){ _x = x; }
// ============================================================================
/// @brief set covariance
///
/// @param P Eigen Matrix
// ============================================================================
void KinematicFilter3::setP (const Eigen::Matrix<double, 6, 6> & P) { _P = P; }
// ============================================================================
/// @brief set process covariance
///
/// @param Q Eigen Matrix
// ============================================================================
void KinematicFilter3::setQ (const Eigen::Matrix<double, 6, 6> & Q) { _Q = Q; }
// ============================================================================
/// @brief set observation covariance
///
/// @param R Eigen Matrix
// ============================================================================
void KinematicFilter3::setR (const Eigen::Matrix<double, 6, 6> & R)  { _R = R; }
...
// ============================================================================
void KinematicFilter3::getX(double * x, int len)
{ 
  assert(len == 6); 
...
/// @return Eigen Matrix
// ============================================================================
const Eigen::Matrix<double,6,1> & KinematicFilter3::getX() const { return _x; }             
// ============================================================================
/// @brief get predicted observation in Eigen
///
/// @return Eigen Matrix
// ============================================================================
const Eigen::Matrix<double,6,1> & KinematicFilter3::getZ() const { return _z; }
// ============================================================================
/// @brief get innovation vector
///
/// @return Eigen Matrix
// ============================================================================
const Eigen::Matrix<double,6,1> & KinematicFilter3::getInnov() const { return _innov; }
// ============================================================================
/// @brief get process covariance
///
/// @return Eigen Matrix
// ============================================================================
const Eigen::Matrix<double,6,6> & KinematicFilter3::getQ() const { return _Q; } 
// ============================================================================
/// @brief get observation covariance
///
/// @return Eigen Matrix
// ============================================================================
const Eigen::Matrix<double,6,6> & KinematicFilter3::getR() const { return _R; }  

void KinematicFilter3::computeKss(const Eigen::Matrix<double,6,6> &A, const Eigen::Matrix<double,6,6> &C, int zDim = 6)
{
...
void KinematicFilter3::RodriguesFormula (const Eigen::Matrix<double,3,1> & u, Eigen::Matrix<double,3,3> & EA) 
{
  EA.setIdentity();
...
void KinematicFilter3::copy(const KinematicFilter3 & other) 
{
  _x = other._x;  
  _z = other._z;
  _innov = other._innov;
...
void KinematicFilter3::dare(const Eigen::Matrix<double,6,6> &A, const Eigen::Matrix<double,6,6> &B, Eigen::Matrix<double,6,6> &P,int zDim = 6) 
{                                      
